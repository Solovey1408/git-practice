...
def test_max_number():
    ...
    assert max_number((-6), 1) == 6, 'Число не равно 6'
    assert max_number(6, 6) == 6, 'Число не равно 6'

test_max_number()
print("Тесты пройдены!")

for i in even_numbers(10): # Вызов функции с перебором каждого элемента, который удовл-т условию цикла в функции
    print (i) # Вывод элементов удовлетворяющих условию